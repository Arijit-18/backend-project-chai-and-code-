...
const logoutUser = asyncHandler(async (req, res) => {
    ...
    await User.findByIdAndUpdate(
        req.user._id,
        {
            $unset: { //this removed the field from the document
                refreshToken: 1
            }
        },
        {
...
//getting subscribers and how many i have subscribed
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    const channel = await User.aggregate([
        ...
        {
            //adding these two fields in the user model 
            $addFields: {
                subscribersCount: {
                    $size: "$subscribers"
                },
        ...
        {
            //does a projection of which values to send 
            $project: {
                fullname: 1,
                username: 1,
                subscribersCount: 1,
